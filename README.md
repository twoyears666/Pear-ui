...
| 包 | 目录 | 版本 | 说明 |
|---|---|---|---|
| PCL2 复刻 · 龙猫蓝 | [pcl2-totoro-blue/](pcl2-totoro-blue/) | 1.1.0 | 按《PCL II 复刻规格》1:1 还原：顶栏页签药丸 + 左栏账号/启动 + 渐变内容区 |

## 安装

**方式一（推荐）：应用内导入**

1. 从 [Releases](../../releases) 下载对应包的 ZIP（如 [pcl2-totoro-blue.zip](../../releases/download/pcl2-totoro-blue-v1.1.0/pcl2-totoro-blue.zip)），也可直接下载包目录内的 ZIP（点击文件 → Download raw file）
