...
local C = {
  ...
  gradFrom    = "#E3EEF9",   -- 内容区渐变起点
  gradTo      = "#D5E5F5",   -- 内容区渐变终点
...
local TABS = {
  ...
  { id = "tab.other",      label = "更多", icon = "sf:ellipsis.circle.fill",              action = "open:mods",     page = "mods" },
}
...
local function capsule(id, label, selected)
  return ui.button {
    ...
    style = selected
      ...
      or  { background = C.white, tint = C.accent, font = 13 },
              ...
              ui.row {
                ...
                children = {
                  ui.button {
                    ...
                    style = { background = C.white, tint = C.text, font = 13 },
                  },
                  ui.button {
                    id = "login",
                    label = "登录",
                    ...
                    style = { background = C.white, tint = C.accent, font = 13 },
                  },
                },
              },
              -- 次要链接（灰色小字，» 开头）
              ...
              ui.row {
                ...
                children = {
                  ui.button {
                    ...
                    style = { background = C.white, tint = C.text, font = 14 },
                  },
                  ui.button {
                    id = "versionSetup",
                    label = "版本设置",
